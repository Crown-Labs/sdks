import { sqrt, Token, CurrencyAmount, TradeType, WETH9, Ether, Percent, Price } from '@kittycorn-labs/sdk-core'
...
import { Pair, Route as V2RouteSDK } from '@kittycorn-labs/v2-sdk'
